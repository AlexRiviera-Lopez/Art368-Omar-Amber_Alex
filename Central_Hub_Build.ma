...
//Last modified: Fri, Dec 03, 2021 11:04:16 PM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "E77F26F5-4182-A6D1-2C97-32851F2FF34F";
createNode transform -s -n "persp";
	rename -uid "D2C3E0DB-44C7-56CE-5357-14810ECD7D27";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 50.309071445205049 87.179840281646563 29.20820092701674 ;
	setAttr ".r" -type "double3" 304.4616473063914 1495.3999999997916 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "5485B2FA-4065-4CF2-258B-E48B5B222AAA";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 106.43691897716184;
...
createNode transform -n "pPlane1";
	rename -uid "C8771F28-4FDE-355E-0EE0-14A6992EF185";
	setAttr ".s" -type "double3" 57.191199851742731 1 32.456214811453002 ;
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	rename -uid "13F3F296-45DA-BE71-5A77-3D8E1ACE022E";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "10B75E99-4DA4-02D0-E052-1C9DC598F462";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "35CE3367-4B97-EF97-0668-50B17CAFD93F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "71A99968-4EFA-6A5D-15BD-18B2D79DE243";
createNode displayLayerManager -n "layerManager";
	rename -uid "44AAF67C-496A-34DC-7F0C-11878C0B3146";
createNode displayLayer -n "defaultLayer";
	rename -uid "F25A4D81-42A2-4682-607F-02A5F927891F";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "11C50995-4171-795A-5FE5-61B25EE0EE82";
...
createNode polyPlane -n "polyPlane1";
	rename -uid "B93A4116-4880-BD0A-7F4A-0D84F2F487A4";
	setAttr ".sw" 25;
	setAttr ".sh" 15;
	setAttr ".cuv" 2;
select -ne :time1;
