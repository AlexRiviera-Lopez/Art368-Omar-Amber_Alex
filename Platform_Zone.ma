...
//Last modified: Sat, Dec 04, 2021 12:24:44 PM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "FE3FBE01-4B9F-EFF5-16F0-DBB741CF93B5";
createNode transform -s -n "persp";
	rename -uid "63FA9907-433B-5C95-8E61-EE927DF56E8B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 23.315314249256975 93.412002784308726 5.4073597560601527 ;
	setAttr ".r" -type "double3" -72.338352747480172 433.80000000031458 -1.1400200983741764e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "C8961419-451A-2602-65D7-09A9226A0565";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 68.178396783107019;
...
createNode transform -n "pCube13";
	...
	setAttr ".t" -type "double3" -9.3386494695383409 16.1303692868124 1.6515813987511474 ;
	setAttr ".r" -type "double3" 0 -89.999999999999986 0 ;
	setAttr ".s" -type "double3" 0.98867841580433502 0.51111109742560457 5.4139628317780764 ;
...
createNode transform -n "pCube17";
	...
	setAttr ".t" -type "double3" 3.8217245050138362 10.86736929581426 -14.459016607608383 ;
	setAttr ".r" -type "double3" 0 -89.999999999999986 0 ;
	setAttr ".s" -type "double3" 6.8446942243698627 0.51111109742560457 1.4328603873997472 ;
...
createNode transform -n "pCube32";
	rename -uid "889B710C-467C-00E3-7E72-06BD5E2A81F8";
	setAttr ".t" -type "double3" 0 -33.683196974810954 0 ;
	setAttr ".rp" -type "double3" 1.8860917091369629 12.857398509979248 -2.5053892135620117 ;
	setAttr ".sp" -type "double3" 1.8860917091369629 12.857398509979248 -2.5053892135620117 ;
createNode mesh -n "pCube32Shape" -p "pCube32";
	rename -uid "48D41510-46B5-5E2D-D1B8-2686CBCE5080";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pCube33";
	rename -uid "0B46DD13-45A7-6C5B-6FBF-CCA3FAC78553";
	setAttr ".t" -type "double3" 12.846622281957909 20.697106036425819 2.3211639253056888 ;
	setAttr ".s" -type "double3" 6.8446942243698627 0.51111109742560457 1.4328603873997472 ;
createNode mesh -n "pCubeShape33" -p "pCube33";
	rename -uid "CF716C25-491A-AD9E-A7C4-D48EC07CE042";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pCube34";
	rename -uid "16BFE05E-488A-214C-B5B6-1988C8B5C5E0";
	setAttr ".t" -type "double3" 12.846622281957909 21.811116639813456 -0.87197298032677217 ;
	setAttr ".s" -type "double3" 6.8446942243698627 0.51111109742560457 1.4328603873997472 ;
createNode mesh -n "pCubeShape34" -p "pCube34";
	rename -uid "0E645D4D-4CB3-0D98-8C69-ECAFF0664623";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "76D7DC8D-42ED-11DD-E6AF-C39537C8CC94";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9A9F42B2-4A34-DBB6-0DD7-BB8777816048";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "53BA2985-44B8-ABBA-3688-3896DD88E508";
createNode displayLayerManager -n "layerManager";
	rename -uid "BFAE8032-4BC0-A8D7-0DDC-C9A8AFDBD937";
createNode displayLayer -n "defaultLayer";
	rename -uid "5365E6CD-4606-535A-DAEA-B9866CABEF92";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0C74AA9F-4DFF-3BD6-9A14-0A8205AB9670";
...
createNode groupId -n "groupId12";
	rename -uid "7DA51ADA-4B8E-EBB5-1550-CAA5126FF713";
	setAttr ".ihi" 0;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "groupId12.id" "pCube32Shape.ciog.cog[1].cgid";
