...
//Last modified: Fri, Nov 19, 2021 08:43:05 PM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "3DA47235-4E32-7FA8-5E19-7AA25CB82465";
createNode transform -s -n "persp";
	rename -uid "EEB5FA21-42A0-1259-02E2-D0A516F72FF2";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 12.225767955900109 80.243870378075457 69.535131030594485 ;
	setAttr ".r" -type "double3" -408.9383527302391 732.19999999995423 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "D045F464-4E53-13CC-946D-4A86EC16950C";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 95.559944954124077;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0F77A916-47D7-378A-64C5-F38F7496BC45";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "E66DAD5D-4B4D-84F9-2669-32B8E0C7E1CE";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "1261BAF7-4C65-18AF-0F95-DE97BC1B616E";
createNode displayLayerManager -n "layerManager";
	rename -uid "7CD1A784-452D-29FB-19C4-59B54598E0F8";
createNode displayLayer -n "defaultLayer";
	rename -uid "A0D7DC90-4DF4-EDE7-9D36-01BC65AD2CD0";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "55685FF9-4D16-A698-71C3-6CB58BB3E2A2";
